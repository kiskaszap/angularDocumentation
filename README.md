...
- [AngularJS Fundamentals on MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/Guide/AngularJS)
- [AngularJS Guide: Component-Based Architecture](https://angularjs.org/guide/component)
- [AngularJS and RESTful Services](https://docs.angularjs.org/tutorial/step_11)
...
- [AngularJS Testing and Debugging](https://docs.angularjs.org/guide/unit-testing)
- [AngularJS Animation Techniques](https://docs.angularjs.org/guide/animations)
- [AngularJS for Enterprise Applications](https://angular.io/guide/enterprise-applications)
- [AngularJS Internationalization and Localization](https://docs.angularjs.org/guide/i18n)
- [AngularJS Routing Configuration](https://docs.angularjs.org/api/ngRoute)
- [Using Promises in AngularJS](https://docs.angularjs.org/api/ng/service/$q)
- [AngularJS Custom Directives](https://docs.angularjs.org/guide/directive)
- [Introduction to AngularJS Modules](https://docs.angularjs.org/guide/module)
- [AngularJS Data Binding Overview](https://docs.angularjs.org/guide/databinding)
- [AngularJS ngModel Directive Guide](https://docs.angularjs.org/api/ng/directive/ngModel)
- [Advanced AngularJS Form Validation](https://docs.angularjs.org/guide/forms)
